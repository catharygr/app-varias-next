...
export default function Collection() {
  // You should map through the data array to generate the product elements

  return (
    <div className={styles.container}>
      {data.map(({ id, name, price, discont, slug }) => (
        <div key={id} className={styles.producto}>
          {/* Use the 'name' and 'price' from the current product */}
